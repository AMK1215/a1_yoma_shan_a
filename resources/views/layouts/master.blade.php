...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('img/logo_2.png') }}" alt="AdminLTELogo" width="200px"
                width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('home') }}" class="brand-link">
                <img src="{{ asset('img/logo_1.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3 brand-text"
                    style="opacity: 6.5">
                <span class="brand-text font-weight-light">A1Yoma</span>
            </a>
